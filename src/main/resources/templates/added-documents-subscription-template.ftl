    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td align="center" valign="center" bgcolor="#333333"
                ...
                <h1 style="color: #ffa941; ">Added documents notification</h1>
            </td>
        </tr>
        <tr style="background-color: #c8c8ca; box-shadow: 0px -10px 10px rgba(0, 0, 0, 0.1);">
            <td align="left" valign="center" bgcolor="#c8c8ca"
                ...
                <p style="font-size: 16px; line-height: 1.5;">
                    We hope you are doing well. It appears that there have been some documents added to an idea that you are subscribed to which has tge following title: "${title}". Here are the new documents:
                </p>
